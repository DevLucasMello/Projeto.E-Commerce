...
namespace PcSantos.UI.Web
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IClienteAppServices, ClienteAppServices>();
            container.RegisterType<IClienteRepository, ClienteRepository>();

            container.RegisterType<IProdutoAppServices, ProdutoAppServices>();
            container.RegisterType<IProdutoRepository, ProdutoRepository>();

            container.RegisterType<IPedidoAppServices, PedidoAppServices>();
